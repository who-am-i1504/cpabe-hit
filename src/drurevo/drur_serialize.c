 ...
 * @LastEditTime: 2020-12-27 21:55:08
                       ...
                       int *offset)
{
    ...
    unserialize_element(b, offset, rupub->h);
    unserialize_element(b, offset, rupub->G);
    unserialize_element(b, offset, rupub->H);
    unserialize_element(b, offset, rupub->f);

    for (int i = 0; i < rupub->m; i ++)
        unserialize_element(b, offset, rupub->fs[i]);
    for (int i = 0; i < rupub->m; i ++)
        unserialize_element(b, offset, rupub->EI[i]);
    for (int i = 0; i < rupub->m; i ++)
        unserialize_element(b, offset, rupub->GI[i]);
    for (int i = 0; i < rupub->m; i ++)
        unserialize_element(b, offset, rupub->ZI[i]);
    for (int i = 0; i < rupub->m; i ++)
        unserialize_element(b, offset, rupub->HJ[i]);
                       ...
                       int *offset)
{
    ...
    for (int i = 0; i < msk->m; i ++)
        unserialize_element(b, offset, msk->alpha[i]);
    for (int i = 0; i < msk->m; i ++)
        unserialize_element(b, offset, msk->r[i]);
    for (int i = 0; i < msk->m; i ++)
        unserialize_element(b, offset, msk->c[i]);
                      ...
                      int *offset)
{
    ...
    unserialize_element(b, offset, cert->u);
                        ...
                        int *offset)
{
    ...
    unserialize_element(b, offset, kx->kx);
    return kx;
}
                       ...
                       int *offset)
{
    ...
    unserialize_element(b, offset, sk->K0);
    ...
    for (int i = 0; i < sk->m; i ++)
    {
        ...
        unserialize_element(b, offset, sk->K_j[i]);
    }
                      ...
                      int *offset)
{
    ...
    unserialize_element(b, offset, user->gpk);
                     ...
                     int *offset)
{
    ...
    unserialize_element(b, offset, auth_pub->egg_alpha);
                         ...
                         int *offset)
{
    ...
    unserialize_element(b, offset, pk->pk);
    return pk;
}
                          ...
                          int *offset)
{
    ...
    unserialize_element(b, offset, msk->vx);
                           ...
                           int *offset)
{
    ...
    for (int i = 0; i < len; i ++)
    {
        ...
        g_hash_table_insert(item->attr_pks, 
            attr, drur_unserialize_attr_pk(pub, b, offset));
        g_ptr_array_add(item->attributes, attr);
    }
                          ...
                          int *offset)
{
    ...
    unserialize_element(b, offset, item->C3);
                     ...
                     int *offset)
{
    ...
    for (int i = 0; i < len; i ++)
    {
        ...
        // element_printf("%B\n", *C2);
        unserialize_element(b, offset, *C2);
